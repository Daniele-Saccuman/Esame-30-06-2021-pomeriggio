...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self.dd_Localization = ft.Dropdown(label="Localization",
                               hint_text="Selezionare la localization", width=200,
                                     options=[ft.dropdown.Option(key="None",
                                                            text="Nessun filtro")],
                                                            on_change=self._controller.read_localization)
        ...
        row1 = ft.Row([self.dd_Localization, self.btn_graph, self.btn_path],
